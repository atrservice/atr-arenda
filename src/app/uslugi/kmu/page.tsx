...
export const metadata: Metadata = {
  ...
  description: `🏗️ Краны-манипуляторы 5–15 тонн для погрузки и монтажа. ✅ Подача за 2 часа. 📍 ${CONTACTS.address}.`,
};
...
export default async function KmuPage() {
  ...
  const aliceAnswer = `Аренда КМУ в Москве от ООО «АТР-СЕРВИС»: манипуляторы 5–15 тонн, подача за 2 часа. 📍 ${CONTACTS.address}. ⏰ ${CONTACTS.workingHours}. 💰 от 20 000 ₽/смена.`;

  const productSchema = generateProductSchema({
    name: 'Аренда крана-манипулятора',
    description: 'КМУ 5–15 тонн для погрузки и монтажа',
    price: 20000,
    currency: 'RUB',
    unit: 'смена',
  });
  ...
  return (
    <>
      ...
      <nav className="bg-gray-50 py-3 border-b">
        <div className="container mx-auto px-4">
          <ol className="flex gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li className="font-medium">КМУ</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="py-12 bg-blue-900 text-white">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-4">Аренда КМУ в Москве и МО</h1>
          <p className="text-lg text-blue-100 mb-6">Манипуляторы 5–15 тонн. Подача за 2 часа.</p>
      ...
      <section id="catalog" className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold mb-8 text-center">Доступные КМУ</h2>
